// #include "../TestFramework/doctest.h"
#include "Direction.hpp"

// Test that the conversion of enum value to components work correctly
// Total of four test cases
// TEST_CASE("Test conversion of North to components")
// {
